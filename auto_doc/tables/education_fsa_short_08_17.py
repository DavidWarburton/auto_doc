...
class EducationFsaShort0817(TrackedTable):
    name = 'education_fsa_short_08_17'

    def build(self, cursor=None):
        cur = self.get_cursor()
        
        cur.execute("""
                    create table education_fsa_short_08_17 as
                    select studyid as study_id, 
                    fsa_skill_name as education_fsa_short_08_17_fsa_skill_name,
                    school_year as education_fsa_short_08_17_school_year,
                    fsa_grade as education_fsa_short_08_17_fsa_grade,
                    max(case when isnumeric(irt_scale_score) then irt_scale_score::numeric
                    else -9 end) as education_fsa_short_08_17_irt_scale_score, 
                    min(case 
                    ...
                    else 0 end) as education_fsa_short_08_17_fsa_5_code
                    from
                    education_fsasclsm8 
                    group by 1,2,3,4 ; 
                    """)
