...
class InBcJulySes3(TrackedTable):
    name = 'in_bc_july_ses3'
    ...
    def build(self, cursor=None):
        ...
        cur.execute("""
                    ...
                    select study_id, demographics_unduped_dob,
                    demographics_unduped_gender ,{ym} as in_bc_july_ses3_ym
                    from ses3
                    where substring(ses3_pat, {mon},1) != '0'
        ...
        cur.execute("""
                    create table in_bc_july_ses3 as 
